...
<button><a href="/view/join.jsp">JOIN NOW</a></button>
 ...
 <div class="container">
        <div class="text">
            <h1><span>S</span>u<span>N</span>il <span>G</span>yM C<span>lu</span>b</h1>
            <p><font color=red>The customer should be able</font><font color=#C0C0C0> to achieve the goal of adipisicing elit., where?</p><p>The guilt of all of them will be fixed
               nor with wise pain!</font><font color=red> Whom does no one hate?</font></p>
                <button><a href="/view/join.jsp">JOIN NOW</a></button>
        </div>
    </div>
